...
public class DetailedMovie {
    ...
    public DetailedMovie(String original_language, String original_title, String overview, String poster_path, String release_date, String title, double vote_average){
